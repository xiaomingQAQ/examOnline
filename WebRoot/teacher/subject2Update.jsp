        ...
        <ul class="breadcrumbs">
         ...
         <div class="maincontent" style="">
            ...
            <div class="widgetcontent">
               <form class="stdform" action="subject2Upadate.action"  method="post">

					<p>
						<label>试题题目</label>
						 <span class="field">
						 <input name="stId" type="hidden" value="${subject2.stID}">
						 <textarea name="stTitle" cols="80" rows="5" class="span5" >${subject2.stTitle}</textarea>
						 </span> 
					</p>
					
					<p>
						<label>试题解析</label>
						 <span class="field"><textarea cols="80" name="stParse" rows="5" class="span5" >${subject2.stParse}</textarea></span> 
					</p>
