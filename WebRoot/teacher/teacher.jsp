            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                	<ul>
                    	...
                    	<li><a href="<%=path %>/teacher/subject2Add.jsp">添加简答题</a></li>
                        ...
                        <li><a href="<%=path %>/teacher/judging.action">给分</a></li>
                    </ul>
                </li>
     ...
     <div class="rightpanel">
        ...
        <div class="maincontent" style="">
            <div class="maincontentinner">
                <img alt="" src="<%=path %>/images/index-bg.png" style='height:100%;width:100%'>
