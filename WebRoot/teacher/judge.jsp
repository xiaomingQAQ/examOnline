                ...
                <table id="dyntable" class="table table-bordered responsive">
                    ...
                    <thead>
                        <tr>                         	
                            ...
                            <th class="head1">试题号</th>
                            <th class="head0">试题题干</th>
                            <th class="head1">试题解析</th> 
                            <th class="head0">学生答案</th>
                            <th class="head1">给分</th>
                        </tr>                      
                    </thead>
                    <tbody>           
               <s:iterator value="#request.stuans" var="stuans">
               <s:set name="studentId" value="#stuans.studentID"/>
				<tr align="center">
					 <td><s:property  value="#stuans.studentID"/></td>
					 <td><s:property  value="#stuans.stID"/></td>
					 <td><s:property  value="#stuans.stTitle"/></td>
					 <td><s:property  value="#stuans.stParse"/></td>
					 <td><s:property  value="#stuans.stuAns"/></td>
					 <td>
						<a href="giveGradeBefore.action?studentId=${studentId}">给分</a>
					 </td>
				</tr>
			</s:iterator>
                    </tbody>
