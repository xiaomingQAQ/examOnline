            ...
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                	<ul>
                        ...
                        <li class="actives"><a href="<%=path %>/teacher/querySubject2.action">查询所有简答题</a></li>
        ...
        <ul class="breadcrumbs">
          ...
          <div class="maincontent">
            <div class="maincontentinner">
               ...
               <s:iterator value="#request.subjects2" var="subject2">
				<tr align="center">
					<td>
						${subject2.stID}
					</td>
					...
					<td>
						<a href="subject2Paticular.action?stId=${subject2.stID}">查看</a>
					</td>
					<td>
						<a href="subject2UpadateBefore.action?stId=${subject2.stID}">更新</a>
					</td>
					<td>
						<a href="subject2Delete?stId=${subject2.stID}">删除</a>
					</td>
				</tr>
			</s:iterator>
                 <tr>
				<td colspan="6" align="center">
					共${page2.totalCount}条纪录，当前第${page2.currentPage}/${page2.totalPage}页，每页${page2.everyPage}条纪录
					<s:if test="#request.page2.hasPrePage">
						<a href="querySubject2Like.action?currentPage=1&subjectTitle=${request.subjectTitle}">首页</a> | 
                		<a href="querySubject2Like.action?currentPage=${page.currentPage - 1}&subjectTitle=${request.subjectTitle}">上一页</a> | 
               		</s:if>
					<s:else>
               		首页 | 上一页 | 
               		</s:else>
					<s:if test="#request.page2.hasNextPage==true">
						<a href="querySubject2Like.action?currentPage=${page.currentPage + 1}&subjectTitle=${request.subjectTitle}">下一页</a> | 
                		<a href="querySubject2Like.action?currentPage=${page.totalPage}&subjectTitle=${request.subjectTitle}">尾页</a>
					</s:if>
					<s:else>
               		下一页 | 尾页
               		</s:else>
