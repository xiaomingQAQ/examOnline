        ...
        <div class="leftmenu">        
            <ul class="nav nav-tabs nav-stacked">
                ...
                <li class="dropdown active"><a href=""><span class="iconfa-briefcase"></span> 试题管理</a>
                	<ul>
                    	<li><a href="<%=path %>/teacher/subjectAdd.action">添加选择题</a></li>
                    	<li class="actives"><a href="<%=path %>/teacher/subject2Add.jsp">添加简答题</a></li>
					...
					<div class="maincontentinner">
						...
						<div class="widget">
							...
							<div class="widgetcontent">
								<form class="stdform" action="subject2Add.action" method="post">
