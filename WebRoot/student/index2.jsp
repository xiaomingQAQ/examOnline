...
<div class="container">
			...
			<div class="examed_uc maincontentinner">
				<h3 style="text-align: center;">武汉大学计算机学院考试</h3>
				<br>
					<div class = "exam_time">  
            <span>剩余时间为：</span><label  name="mss" id="mss"></label>   
				...
				<div class="questionCell" id="D_Title_P">
					<div class="titleBar">
						<span><b id="D_Title">简答题(20分)</b></span>
						<div class="clear"></div>
					</div>
					<form action="submitExam2.action" method="post">
					<s:iterator value="#request.subjects2" var="subject2" status="sta">
					<div class="question">
						<input type="hidden" name="stID" value="${subject2.stID}" />
						<p>${sta.index + 1}、${subject2.stTitle}（）&nbsp;(<span class="D_score">20.00</span>分)</p>
						<ul>
						<span class="field"><textarea name="answer" cols="80" rows="5" class="span5"></textarea></span> 
						</ul>
					</div>
					</s:iterator><br>					
						<div align="center">
						<input type="submit" value=" 提交试卷" name="Submit" />
					</div>
					</form>
